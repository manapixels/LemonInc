...
public class EndScreen implements Screen{
    ...
    private PerspectiveCamera gamecam;
    ...
    private Label winner, second, third, last;
    Music music;
    Boolean playmusic;
    private Sound gongSound, soundclick;
    ...
    public EndScreen(final NimbusRun game, Boolean playmusic){
